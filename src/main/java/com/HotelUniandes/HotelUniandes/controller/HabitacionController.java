...
public class HabitacionController {
    ...
    @PostMapping("/save")
    public ResponseEntity<String> createHabitacion( @RequestBody Habitacion h, @RequestAttribute int idTipo){
        sr.saveHabitacion(h, idTipo);
        return new ResponseEntity<String>(sr.saveHabitacion(h,idTipo), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Habitacion> updateHabitacionByTipo(@PathVariable int id, @RequestBody Habitacion h, @RequestBody int idTipo){
